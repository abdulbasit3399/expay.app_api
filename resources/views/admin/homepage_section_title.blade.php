...
@section('title')
<title>{{__('Homepage Section Title')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{__('Homepage Section Title')}}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active">
                        <a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a>
                    </div>
                    <div class="breadcrumb-item">{{__('Homepage Section Title')}}</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.update-homepage-section-title') }}" method="post">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            <th width="50%">{{__('Default')}}</th>
                                            <th width="50%">{{__('Changable')}}</th>
                                        </tr>
