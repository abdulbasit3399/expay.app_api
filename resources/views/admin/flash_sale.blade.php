                        ...
                        <form action="{{ route('admin.update-flash-sale') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <label>{{__('Homepage Image Preview')}}</label>
                                    <div>
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('Homepage Image')}} <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control-file"  name="homepage_image">
                                </div>

                                <div class="form-group col-12">
                                    <label>{{__('Flash Sale Page Image Preview')}}</label>
                                    <div>
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('Flash Sale Page Image')}} <span class="text-danger">*</span></label>
