...
@section('title')
<title>{{__('Featured Category')}}</title>
@endsection
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{__('Featured Category')}}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active">
                        <a href="{{ route('admin.dashboard') }}">{{__('admin.Dashboard')}}</a>
                    </div>
                    <div class="breadcrumb-item">{{__('aFeatured Category')}}</div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('admin.featured-category-banner') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{__('Featured Category Sidebar Banner')}}</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="modal-header">
                            <h5 class="modal-title">{{__('Add featured category')}}</h5>
