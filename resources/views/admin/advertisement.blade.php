              ...
              <div class="col-12 col-sm-12 col-md-4">
                <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link active" id="error-tab-1" data-toggle="tab" href="#errorTab-1" role="tab" aria-controls="errorTab-1" aria-selected="true">{{__('Slider Sidebar Banner One')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="one-column-banner-tab" data-toggle="tab" href="#oneColumnBanner" role="tab" aria-controls="oneColumnBanner" aria-selected="true">{{__('Slider Sidebar Banner Two')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="two-column-banner-first" data-toggle="tab" href="#twoColumnBannerFirst" role="tab" aria-controls="twoColumnBannerFirst" aria-selected="true">{{__('Popular Category Sidebar Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="two-column-banner-second" data-toggle="tab" href="#twoColumnBannerSecond" role="tab" aria-controls="twoColumnBannerSecond" aria-selected="true">{{__('Homepage Two Column First Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="two-column-banner-third" data-toggle="tab" href="#twoColumnBannerThird" role="tab" aria-controls="twoColumnBannerThird" aria-selected="true">{{__('Homepage Two Column Second Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="shop-page" data-toggle="tab" href="#shopPage" role="tab" aria-controls="shopPage" aria-selected="true">{{__('Homepage Single Banner One')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="product-details" data-toggle="tab" href="#productDetails" role="tab" aria-controls="productDetails" aria-selected="true">{{__('Homepage Single Banner Two')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="cart-bottom-banner" data-toggle="tab" href="#cartBottomBanner" role="tab" aria-controls="cartBottomBanner" aria-selected="true">{{__('Mobile App Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="campaign-page" data-toggle="tab" href="#campaignPage" role="tab" aria-controls="campaignPage" aria-selected="true">{{__('Shop Page Center Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="shoppage-sidebar-page" data-toggle="tab" href="#shopPageSidebarBanner" role="tab" aria-controls="shopPageSidebarBanner" aria-selected="true">{{__('Shop Page Sidebar Banner')}}</a>
                  </li>

                  <li class="nav-item border rounded mb-1">
                    <a class="nav-link" id="megamanu-banner" data-toggle="tab" href="#megaMenuBanner" role="tab" aria-controls="megaMenuBanner" aria-selected="true">{{__('Mega Menu Banner')}}</a>
                  </li>
                        ...
                        <div class="card-body">
                          <form action="{{ route('admin.slider-banner-one') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Current Banner')}} AR</label>
                                <div>
                                  <img src="{{ asset($sliderSidebarBannerOne->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>

                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                                <input type="file" name="banner_image_ar" class="form-control-file">
                              </div>
                              ...
                              <div class="form-group col-12">
                                ...
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $sliderSidebarBannerOne->title_one_ar }}">
                              </div>
                              <div class="form-group col-12">
                              ...
                              <div class="form-group col-12">
                                ...
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $sliderSidebarBannerOne->title_two_ar }}">
                              </div>
                              <div class="form-group col-12">
                              ...
                              <div class="form-group col-12">
                                ...
                                <input type="text" name="badge_ar" class="form-control" value="{{ $sliderSidebarBannerOne->badge_ar }}">
                              </div>



                              <div class="form-group col-12">
                                <label>{{__('Category Link')}} <span class="text-danger">*</span></label>
                          ...
                          <form action="{{ route('admin.slider-banner-two') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Current Banner')}} AR</label>
                                <div>
                                  <img src="{{ asset($sliderSidebarBannerTwo->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title One')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $sliderSidebarBannerTwo->title_one_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $sliderSidebarBannerTwo->title_two_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="badge_ar" class="form-control" value="{{ $sliderSidebarBannerTwo->badge_ar }}">
                              </div>
                        ...
                        <div class="card-body">
                          <form action="{{ route('admin.popular-category-sidebar') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($popularCategorySidebarBanner->image) }}" alt="" width="200px">
                                </div>
                              </div>
                          ...
                          <form action="{{ route('admin.homepage-two-col-first-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($homepageTwoColumnBannerOne->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title One')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $homepageTwoColumnBannerOne->title_one_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $homepageTwoColumnBannerOne->title_two_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="badge_ar" class="form-control" value="{{ $homepageTwoColumnBannerOne->badge_ar }}">
                              </div>
                          ...
                          <form action="{{ route('admin.homepage-two-col-second-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($homepageTwoColumnBannerTwo->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title One')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $homepageTwoColumnBannerTwo->title_one_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $homepageTwoColumnBannerTwo->title_two_ar }}">
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} <span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Badge')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="badge_ar" class="form-control" value="{{ $homepageTwoColumnBannerTwo->badge_ar }}">
                              </div>
                      ...
                      <div class="card m-0">
                        <div class="card-body">
                          <form action="{{ route('admin.homepage-single-first-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              <label for="">{{__('admin.Existing Banner')}} AR</label>
                              <div>
                                <img src="{{ asset($homepageSingleBannerOne->image_ar) }}" width="200px" alt="">
                              </div>
                            </div>

                            <div class="form-group">
                              <label for="">{{__('admin.New Banner')}} AR</label>
                              <input type="file" class="form-control-file" name="banner_image_ar">
                            </div>
                            ...
                            <div class="form-group">
                              <label>{{__('Title One')}} <span class="text-danger">*</span></label>
                              <input type="text" name="title_one_ar" class="form-control" value="{{ $homepageSingleBannerOne->title_one_ar }}">
                            </div>
                            ...
                            <div class="form-group">
                              <label>{{__('Title Two')}} <span class="text-danger">*</span></label>
                              <input type="text" name="title_two_ar" class="form-control" value="{{ $homepageSingleBannerOne->title_two_ar }}">
                            </div>
                        ...
                        <div class="card-body">
                          <form action="{{ route('admin.homepage-single-second-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Existing Banner')}} AR</label>
                                <div>
                                  <img src="{{ asset($homepageSingleBannerTwo->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                ...
                                <input type="text" name="title_ar" class="form-control" value="{{ $homepageSingleBannerTwo->title_one_ar }}">
                              </div>
                        ...
                        <div class="card-body">
                          <form action="{{ route('admin.homepage-flash-sale-sidebar-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Existing Banner')}} AR</label>
                                <div>
                                  <img src="{{ asset($homepageFlashSaleSidebarBanner->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Play store link')}} <span class="text-danger">*</span></label>
                                <input type="text" name="link"  class="form-control" value="{{ $homepageFlashSaleSidebarBanner->link }}">
                              </div>

                              <div class="form-group col-12">
                                <label>{{__('App store link')}} <span class="text-danger">*</span></label>
                          ...
                          <form action="{{ route('admin.shop-page-center-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($shopPageCenterBanner->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title')}} <span class="text-danger">*</span></label>
                                <input type="text" name="title_ar" class="form-control" value="{{ $shopPageCenterBanner->title_one_ar }}">
                              </div>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('After Product Qty')}} <span class="text-danger">*</span></label>
                          ...
                          <form action="{{ route('admin.shop-page-sidebar-banner') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($shopPageSidebarBanner->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title One')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $shopPageSidebarBanner->title_one_ar }}">
                              </div>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $shopPageSidebarBanner->title_two_ar }}">
                              </div>
                          ...
                          <form action="{{ route('admin.mega-menu-banner-update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-12">
                                <label>{{__('admin.Banner One')}} AR</label>
                                <div>
                                  <img src="{{ asset($megaMenuBanner->image_ar) }}" alt="" width="200px">
                                </div>
                              </div>
                              <div class="form-group col-12">
                                <label>{{__('admin.New Banner')}} AR</label>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title One')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_one_ar" class="form-control" value="{{ $megaMenuBanner->title_one_ar }}">
                              </div>
                              ...
                              <div class="form-group col-12">
                                <label>{{__('Title Two')}} AR<span class="text-danger">*</span></label>
                                <input type="text" name="title_two_ar" class="form-control" value="{{ $megaMenuBanner->title_two_ar }}">
                              </div>
