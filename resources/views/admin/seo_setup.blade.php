                        ...
                        <div class="card-body">
                          <form action="{{ route('admin.update-seo-setup',$page->id) }}" method="POST">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                  <label for="">{{__('admin.SEO Title')}} AR</label>
                                  <input type="text" name="seo_title_ar" class="form-control" value="{{ $page->seo_title_ar }}">
                                </div>
                              </div>
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                  <label for="">{{__('admin.SEO Description')}} AR</label>
                                  <textarea name="seo_description_ar" id="" cols="30" rows="5" class="form-control text-area-5">{{ $page->seo_description_ar }}</textarea>
