          ...
          <div class="card">
            <div class="card-body">
              <form action="{{ route('admin.update-email-template',$template->id) }}" method="POST">
                ...
                <div class="form-group">
                  <label for="">{{__('admin.Subject')}} AR<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" value="{{ $template->subject_ar }}" name="subject_ar">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="">{{__('admin.Description')}} AR<span class="text-danger">*</span></label>
                  <textarea name="description_ar" cols="30" rows="10" class="form-control summernote">{{ $template->description_ar }}</textarea>
                </div>
