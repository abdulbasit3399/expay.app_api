              ...
              <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-12">
                    ...
                    <div>
                      <input type="checkbox"name="top_product" id="top_product"> <label for="top_product" class="mr-3" >{{__('Top Product')}}</label>

                      <input type="checkbox" name="new_arrival" id="new_arrival"> <label for="new_arrival" class="mr-3" >{{__('New Arrival')}}</label>

                      <input type="checkbox" name="best_product" id="best_product"> <label for="best_product" class="mr-3" >{{__('Best Product')}}</label>

                      <input type="checkbox" name="is_featured" id="is_featured"> <label for="is_featured" class="mr-3" >{{__('Featured Product')}}</label>
                    </div>
                  </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{ route('admin.product-import') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group col-12">
                  <label>Variants<span class="text-danger">*</span></label>
              ...
              <a href="{{route('admin.product-translate')}}" class="btn btn-success">Translate Products to Arabic</a>
            </div>
          </div>
        </div>
      </div>
