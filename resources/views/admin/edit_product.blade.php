            ...
            <div class="card-body">
              <form action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-12">
                    <label>{{__('admin.Short Name')}} AR<span class="text-danger">*</span></label>
                    <input type="text" id="short_name_ar" class="form-control"  name="short_name_ar" value="{{ $product->short_name_ar }}">
                  </div>
                  ...
                  <div class="form-group col-12">
                    <label>{{__('admin.Short Description') }} AR<span class="text-danger">*</span></label>
                    <textarea name="short_description_ar" id="" cols="30" rows="10" class="form-control text-area-5">{{ $product->short_description_ar }}</textarea>
                  </div>

                  <div class="form-group col-12">
                    <label>{{__('admin.Long Description')}} AR<span class="text-danger">*</span></label>
                    <textarea name="long_description_ar" id="" cols="30" rows="10" class="summernote">{{ $product->long_description_ar }}</textarea>
                  </div>
                  ...
                  <div class="form-group col-12">
                    ...
                    <div>
                      ...
                      <input {{ $product->is_top == 1 ? 'checked' : '' }} type="checkbox"name="top_product" id="top_product"> <label for="top_product" class="mr-3" >{{__('Top Product')}}</label>

                      <input {{ $product->new_product == 1 ? 'checked' : '' }}  type="checkbox" name="new_arrival" id="new_arrival"> <label for="new_arrival" class="mr-3" >{{__('New Arrival')}}</label>

                      <input {{ $product->is_best == 1 ? 'checked' : '' }}  type="checkbox" name="best_product" id="best_product"> <label for="best_product" class="mr-3" >{{__('Best Product')}}</label>

                      <input {{ $product->is_featured == 1 ? 'checked' : '' }}  type="checkbox" name="is_featured" id="is_featured"> <label for="is_featured" class="mr-3" >{{__('Featured Product')}}</label>
                    </div>
                  </div>

                  @if ($product->vendor_id != 0)
                  <div class="form-group col-12">
                    <label>{{__('Product Request from seller')}} <span class="text-danger">*</span></label>
                    <select name="approve_by_admin" class="form-control">
                      <option {{ $product->approve_by_admin == 1 ? 'selected' : '' }} value="1">{{__('Approved')}}</option>
                      <option {{ $product->approve_by_admin == 0 ? 'selected' : '' }} value="0">{{__('Pending')}}</option>
                    </select>
                  </div>
                  @endif
