      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.product-category.*') || Route::is('admin.product-sub-category.*') || Route::is('admin.product-child-category.*') || Route::is('admin.mega-menu-category.*') || Route::is('admin.mega-menu-sub-category') || Route::is('admin.create-mega-menu-sub-category') || Route::is('admin.edit-mega-menu-sub-category') || Route::is('admin.mega-menu-banner') || Route::is('admin.popular-category') || Route::is('admin.featured-category') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ Route::is('admin.mega-menu-category.*') || Route::is('admin.mega-menu-sub-category') || Route::is('admin.create-mega-menu-sub-category') || Route::is('admin.edit-mega-menu-sub-category') || Route::is('admin.mega-menu-banner') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.mega-menu-category.index') }}">{{__('Mega Menu Category')}}</a></li>

              <li class="{{ Route::is('admin.popular-category') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.popular-category') }}">{{__('Popular Category')}}</a></li>

              <li class="{{ Route::is('admin.featured-category') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.featured-category') }}">{{__('Featured Category')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.product.*') || Route::is('admin.product-brand.*') || Route::is('admin.product-variant') || Route::is('admin.create-product-variant') || Route::is('admin.edit-product-variant') || Route::is('admin.product-gallery') || Route::is('admin.product-variant-item') || Route::is('admin.create-product-variant-item') || Route::is('admin.edit-product-variant-item') || Route::is('admin.product-review') || Route::is('admin.show-product-review') || Route::is('admin.seller-product') || Route::is('admin.seller-pending-product') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.product-highlight') ||  Route::is('admin.product-report') || Route::is('admin.show-product-report') || Route::is('admin.specification-key.*') || Route::is('admin.stockout-product') ? 'active' : '' }}">
            ...
            <li class="{{ Route::is('admin.product.*') || Route::is('admin.product-variant') || Route::is('admin.create-product-variant') || Route::is('admin.edit-product-variant') || Route::is('admin.product-gallery') || Route::is('admin.product-variant-item') || Route::is('admin.create-product-variant-item') || Route::is('admin.edit-product-variant-item') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.product-highlight') || Route::is('admin.trendy-products') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product.index') }}">{{__('admin.Products')}}</a></li>

            <li class="{{ Route::is('admin.trendy-products') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.trendy-products') }}">Trendy {{__('admin.Products')}}</a></li>

            <li class="{{ Route::is('admin.stockout-product') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.stockout-product') }}">{{__('Stock out')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.country.*') || Route::is('admin.state.*') || Route::is('admin.city.*') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                <li class="{{ Route::is('admin.country.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.country.index') }}">{{__('Country / Region')}}</a></li>
                <li class="{{ Route::is('admin.state.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.state.index') }}">{{__('State / Province')}}</a></li>
                <li class="{{ Route::is('admin.city.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.city.index') }}">{{__('City / Delivery Area')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.flash-sale') || Route::is('admin.currency.*') || Route::is('admin.shipping.*') || Route::is('admin.coupon.*') || Route::is('admin.payment-method') || Route::is('admin.flash-sale-product') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                <li class="{{ Route::is('admin.flash-sale') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.flash-sale') }}">{{__('Flash Sale')}}</a></li>

                <li class="{{ Route::is('admin.flash-sale-product') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.flash-sale-product') }}">{{__('Flash Sale Product')}}</a></li>

                <li class="{{ Route::is('admin.coupon.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.coupon.index') }}">{{__('admin.Coupon')}}</a></li>

                <li class="{{ Route::is('admin.shipping.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.shipping.index') }}">{{__('Shipping Rule')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.service.*') || Route::is('admin.maintainance-mode') || Route::is('admin.announcement') ||  Route::is('admin.slider.*') || Route::is('admin.home-page') || Route::is('admin.banner-image.index') || Route::is('admin.homepage-one-visibility') || Route::is('admin.cart-bottom-banner') || Route::is('admin.shop-page') || Route::is('admin.seo-setup') || Route::is('admin.menu-visibility') || Route::is('admin.product-detail-page') || Route::is('admin.default-avatar') || Route::is('admin.seller-conditions') || Route::is('admin.subscription-banner') || Route::is('admin.testimonial.*') || Route::is('admin.homepage-section-title') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.slider1.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider1.index') }}">{{__('Slider 1')}}</a></li>
                <li class="{{ Route::is('admin.slider2.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider2.index') }}">{{__('Slider 2')}}</a></li>
                <li class="{{ Route::is('admin.slider3.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider3.index') }}">{{__('Slider 3')}}</a></li>
                <li class="{{ Route::is('admin.slider4.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider4.index') }}">{{__('Slider 4')}}</a></li>
                <li class="{{ Route::is('admin.slider5.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider5.index') }}">{{__('Slider 5')}}</a></li>
                <li class="{{ Route::is('admin.slider6.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider6.index') }}">{{__('Slider 6')}}</a></li>
                <li class="{{ Route::is('admin.slider7.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider7.index') }}">{{__('Slider 7')}}</a></li>
                <li class="{{ Route::is('admin.slider8.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider8.index') }}">{{__('Slider 8')}}</a></li>
                <li class="{{ Route::is('admin.slider9.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider9.index') }}">{{__('Slider 9')}}</a></li>
                <li class="{{ Route::is('admin.slider10.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.slider10.index') }}">{{__('Slider 10')}}</a></li>
                ...
                <li class="{{ Route::is('admin.homepage-section-title') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.homepage-section-title') }}">{{__('Homepage Section Title')}}</a></li>
                ...
                <li class="{{ Route::is('admin.subscription-banner') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.subscription-banner') }}">{{__('Subscription Banner')}}</a></li>
