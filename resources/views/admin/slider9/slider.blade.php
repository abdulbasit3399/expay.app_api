      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <a href="{{ route('admin.slider9.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($sliders as $index => $slider)
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('admin.slider9.edit',$slider->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/slider9/") }}'+"/"+id)
    }
    function changeProductCategoryStatus(id){
        ...
        $.ajax({
            ...
            url:"{{url('/admin/slider9-status/')}}"+"/"+id,
