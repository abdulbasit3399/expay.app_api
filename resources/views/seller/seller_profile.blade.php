                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ route('seller.shop-profile') }}" class="btn btn-success btn-block btn-lg my-2">{{__('user.Go To Shop')}}</a>
                                </div>
                                <div class="col-12">
                                    <a href="{{ route('seller.product-review') }}" class="btn btn-primary btn-block btn-lg my-2">{{__('user.My Reviews')}}</a>
                                </div>
                                <div class="col-12">
                                    <a href="{{ route('seller.email-history') }}" class="btn btn-info btn-block btn-lg my-2">{{__('user.Email Log')}}</a>
                                </div>
                                <div class="col-12">
                                    <a href="{{ route('seller.change-password') }}" class="btn btn-warning btn-block btn-lg my-2">{{__('user.Change Password')}}</a>
                                </div>
