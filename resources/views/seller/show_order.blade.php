          ...
          <div class="section-body">
            <div class="invoice">
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-lg-6 text-right">
                        <div class="invoice-detail-item">
                            ...
                            @endphp
                            <div class="invoice-detail-name">{{__('user.Subtotal')}} : {{ $setting->currency_icon }}{{ round($sub_total, 2) }}</div>
                          </div>
                          <div class="invoice-detail-item">
                        ...
                        <hr class="mt-2 mb-2">
                        <div class="invoice-detail-item">
                          <div class="invoice-detail-value invoice-detail-value-lg">{{__('user.Total')}} : {{ $setting->currency_icon }}{{ round($order->total_amount, 2) }}</div>
                        </div>
                      </div>
              ...
              <div class="text-md-right print-area">
                <hr>
                <button class="btn btn-success btn-icon icon-left print_btn"><i class="fas fa-print"></i> {{__('user.Print')}}</button>
              </div>
            </div>
          </div>
