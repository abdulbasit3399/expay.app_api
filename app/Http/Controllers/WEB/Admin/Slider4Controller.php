...
use App\Models\Slider4;
use App\Models\Brand;
use Image;
use File;
use Stichoza\GoogleTranslate\GoogleTranslate;
class Slider4Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider4::all();
        return view('admin.slider4.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider4.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider4::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider4.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider4.index')->with($notification);
    }
