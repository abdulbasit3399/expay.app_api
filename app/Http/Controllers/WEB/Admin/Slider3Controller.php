...
class Slider3Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider3::all();
        return view('admin.slider3.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider3.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider3::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider3.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider3.index')->with($notification);
    }
