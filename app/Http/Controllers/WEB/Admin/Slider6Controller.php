...
use App\Models\Slider6;
use App\Models\Brand;
use Image;
use File;
use Stichoza\GoogleTranslate\GoogleTranslate;
class Slider6Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider6::all();
        return view('admin.slider6.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider6.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider6::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider6.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider6.index')->with($notification);
    }
