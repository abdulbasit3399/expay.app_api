...
class Slider2Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider2::all();
        return view('admin.slider2.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider2.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider2::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider2.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider2.index')->with($notification);
    }
