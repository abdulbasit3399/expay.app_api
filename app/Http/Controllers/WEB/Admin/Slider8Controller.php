...
use App\Models\Slider8;
use App\Models\Product;
use Image;
use File;
use Stichoza\GoogleTranslate\GoogleTranslate;
class Slider8Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider8::all();
        return view('admin.slider8.slider', compact('sliders'));
    }

    public function create(){
        $products = Product::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider8.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider8::find($id);
        $products = Product::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider8.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider8.index')->with($notification);
    }
