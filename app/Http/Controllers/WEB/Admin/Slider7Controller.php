...
use App\Models\Slider7;
use App\Models\Brand;
use Image;
use File;
use Stichoza\GoogleTranslate\GoogleTranslate;
class Slider7Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider7::all();
        return view('admin.slider7.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider7.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider7::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider7.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider7.index')->with($notification);
    }
