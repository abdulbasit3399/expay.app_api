...
use App\Models\Slider5;
use App\Models\Brand;
use Image;
use File;
use Stichoza\GoogleTranslate\GoogleTranslate;
class Slider5Controller extends Controller
{
    ...
    public function index(){
        $sliders = Slider5::all();
        return view('admin.slider5.slider', compact('sliders'));
    }

    public function create(){
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider5.create_slider', compact('products'));
    }
    ...
    public function edit($id){
        $slider = Slider5::find($id);
        $products = Brand::where(['status' => 1])->select('id','name','slug')->get();
        return view('admin.slider5.edit_slider', compact('slider','products'));
    }
    ...
    public function update(Request $request, $id){
        ...
        $notification=array('messege'=>$notification,'alert-type'=>'success');
        return redirect()->route('admin.slider5.index')->with($notification);
    }
