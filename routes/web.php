...
use App\Http\Controllers\WEB\Admin\Slider1Controller;
use App\Http\Controllers\WEB\Admin\Slider2Controller;
use App\Http\Controllers\WEB\Admin\Slider3Controller;
use App\Http\Controllers\WEB\Admin\Slider4Controller;
use App\Http\Controllers\WEB\Admin\Slider5Controller;
use App\Http\Controllers\WEB\Admin\Slider6Controller;
use App\Http\Controllers\WEB\Admin\Slider7Controller;
use App\Http\Controllers\WEB\Admin\Slider8Controller;
use App\Http\Controllers\WEB\Admin\Slider9Controller;
use App\Http\Controllers\WEB\Admin\Slider10Controller;
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::resource('slider4', Slider4Controller::class);
    Route::resource('slider5', Slider5Controller::class);
    Route::resource('slider6', Slider6Controller::class);
    Route::resource('slider7', Slider7Controller::class);
    Route::resource('slider8', Slider8Controller::class);
    Route::resource('slider9', Slider9Controller::class);
    Route::resource('slider10', Slider10Controller::class);
    Route::put('slider-status/{id}',[SliderController::class,'changeStatus'])->name('slider-status');
    Route::put('slider1-status/{id}',[Slider1Controller::class,'changeStatus'])->name('slider1-status');
    Route::put('slider2-status/{id}',[Slider2Controller::class,'changeStatus'])->name('slider2-status');
    Route::put('slider3-status/{id}',[Slider3Controller::class,'changeStatus'])->name('slider3-status');
    Route::put('slider4-status/{id}',[Slider4Controller::class,'changeStatus'])->name('slider4-status');
    Route::put('slider5-status/{id}',[Slider5Controller::class,'changeStatus'])->name('slider5-status');
    Route::put('slider6-status/{id}',[Slider6Controller::class,'changeStatus'])->name('slider6-status');
    Route::put('slider7-status/{id}',[Slider7Controller::class,'changeStatus'])->name('slider7-status');
    Route::put('slider8-status/{id}',[Slider8Controller::class,'changeStatus'])->name('slider8-status');
    Route::put('slider9-status/{id}',[Slider9Controller::class,'changeStatus'])->name('slider9-status');
    Route::put('slider10-status/{id}',[Slider10Controller::class,'changeStatus'])->name('slider10-status');
